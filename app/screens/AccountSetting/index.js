  ...
  return (
    <View style={styles.PrivacyPolicy}>
      <View style={styles.Group642}>
        ...
        />
        <Text style={styles.Txt432}>Account Settings</Text>
      </View>
      <Text
        style={{
          color: 'white',
        ...
        Here are your all settings
      </Text>
      <View
        style={{flexDirection: 'row', marginTop: 30, marginHorizontal: 10}}
        onTouchEnd={() => navigation.navigate('NotificationSetting')}>
      ...
      <View
        ...
        onTouchEnd={() =>
          navigation.navigate('ForgotPasswordEmail', {method: 'change'})
        }>
      ...
      <View
        ...
        onTouchEnd={() =>
          navigation.navigate('EditProfile', {
            accoutType: route.params?.accoutType,
      ...
      <View
        style={{flexDirection: 'row', marginTop: 20, marginHorizontal: 10}}
        onTouchEnd={() =>
          navigation.navigate('FriendsList', {id: route.params?.id})
        }>
